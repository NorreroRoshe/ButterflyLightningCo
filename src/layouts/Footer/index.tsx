      ...
      <footer className={cls.footer}>
        <div className={`${cls.footer__container} ${cls.container}`}>
          <div className={`${cls.footer_nav} ${cls.footer_nav_first}`}>
            <h4 className={cls.footer_nav__title}>Информация</h4>
            <ul className={cls.footer_nav__list}>
              <li className={cls.footer_nav__item}>
                <Link href="/AboutUs" className={cls.nav_link}>
                  О нас
                </Link>
                <Link href="/Paypage" className={cls.nav_link}>
                  Оплата
                </Link>
                <Link href="/Delivery" className={cls.nav_link}>
                  Доставка
                </Link>
          ...
          <Link className={cls.footer_nav_work_logo} href="/"></Link>
          ...
          <div className={cls.footer_nav}>
            ...
            <div className={cls.footer_nav__callwu}>
              ...
              <a href="tel:+79037303001" className={cls.footer_callwu_link}>
                ...
                <span className={cls.footer_callwu__phonenum}> +7 (903) 730-30-01 </span>
              </a>
              <a href="mailto:info@butterflylc.ru" className={cls.footer_callwu_link}>
                <svg
                ...
                <span className={cls.footer_callwu__phonenum}> info@butterflylc.ru</span>
              </a>
              <div className={cls.footer_callwu_wrapper_media}>
                <a href="tel:+79037303001" className={cls.footer_callwu_link_media}>
                  <svg className={cls.footer_callwu__icon} height="24" width="30">
                    <g transform="matrix(1,0,0,1,0,0)">
                      <svg height="24" viewBox="0 0 30 24" width="24">
                        <path
                ...
                <a href="mailto:info@butterflylc.ru" className={cls.footer_callwu_link_media}>
                  <svg
                    className={cls.footer_communic__icon}
                    height="24"
                    viewBox="0 0 240 240"
            ...
            <div className={cls.footer__nav_social}>
              ...
              <a href="" className={cls.nav_social_link}>
                <Image
                  width={25}
                  height={25}
                  src={instaicon}
