...
export const Delivery: React.FC = () => {
  return (
    <section className={cls.section_delivery}>
      <div className={`${cls.delivery_container} ${cls.container}`}>
        <div className={cls.delivery_info}>
          <h3 className={cls.delivery_header}>Условия доставки компании ButterflyLC</h3>
          <br />
          <div className={cls.delivery_desc}>
            ...
            <p className={cls.desc_txt}>-внутри Садового кольца:</p>
            <p className={cls.desc_txt}>малогабаритная - 1500 руб. и крупногабаритная - 3000 руб.;</p>
            <p className={cls.desc_txt}>-дальше Садового кольца:</p>
            <p className={cls.desc_txt}>малогабаритная - 1000 руб и крупногабаритная - 2500 руб.</p>
            <p className={cls.desc_txt}>
            ...
            <p className={cls.desc_txt}>-информирование о статусе груза</p>
            <p className={cls.desc_txt}>Это правило по умолчанию действует для всех заказов.</p>
            <p className={cls.desc_txt}>
            ...
            <p className={`${cls.desc_txt} ${cls.desc_blue}`}>
