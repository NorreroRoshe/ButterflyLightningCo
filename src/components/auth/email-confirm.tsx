...
{newCode && (
  <div className="text-sm sm:text-15px text-skin-muted text-center">
    ...
    >
      ...
      <br />
       В случае если кода нет ни в одной из папок на указанной почте, то просим связаться с нами по почте 'info@butterflylc.ru', либо по номеру телефона +7-903-730-30-01.
    </span>
  </div>
)}
