...
import { Swiper, Navigation, Autoplay, Pagination, Grid } from '@/components/ui/carousel/slider';
...
const Carousel: React.FunctionComponent<CarouselPropsType> = ({
  ...
  return (
    <div
      ...
      {Boolean(navigation) && (
        <div className={`flex items-center w-full absolute top-2/4 z-10 ${buttonGroupClassName}`}>
