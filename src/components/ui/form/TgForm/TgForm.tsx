...
import cls from './TgForm.module.scss';
...
export const TgForm:React.FC<CounterProps> = ({id, art ,price, notSalePrice, styles, sendStyle, subStyles}) => {
  ...
  return (
    <div style={subStyles} className={cls.collab_subscribe}>
      ...
      <p className={`${cls.after_send} ${isSent ? cls.after_send_true : ''}`} style={sendStyle}>
